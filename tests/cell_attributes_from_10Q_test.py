#
# cell_attributes_from_10Q_test.py
# Test the cell attributes extraction from a 10Q report
#
...
class TestCellAttributesExtraction10Q(unittest.TestCase):
    """Test the cell attributes extraction process"""

    def setUp(self):
        # Load a test 10-Q report and extract data
    ...
    def test_header_cells(self):
        ...
        :return:
        """
        first_cell = self.table_10Q['Cells'][0][0]
...
suite = unittest.TestLoader().loadTestsFromTestCase(TestCellAttributesExtraction10Q)
